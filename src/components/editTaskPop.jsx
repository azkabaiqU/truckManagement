...
<section className=' fixed top-0 left-0 w-full h-full bg-black/40 z-50 flex justify-center items-center'>
  <div className="mx-10 w-full max-w-5xl bg-white rounded-2xl p-8">
    ...
    <form>
      <div className="grid grid-cols-3 gap-10">
        ...
        <div>
          ...
          <input type="text" id="containerNumber"
            className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#000000]" placeholder="XSDR45" />
      ...
      <div className="flex justify-between mt-10">
        <button onClick={onClose} type="button"
          className="py-4 px-8 rounded-xl bg-[#F8F8F8] hover:bg-transparent duration-200">Go back</button>

        <button type="submit"
          className="py-4 px-8 rounded-xl bg-black text-white hover:bg-transparent hover:text-black duration-100">Save
          edit</button>
      </div>
    </form>
  </div>
