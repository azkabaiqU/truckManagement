    ...
    <form className=''>
      <div className="flex md:flex-row flex-col gap-10">
        ...
        <div className='md:w-1/3 w-full'>
          ...
          <select id="licenseType" className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#C0C0C0]">
        ...
        <div className='md:w-1/3 w-full'>
          ...
          <input type="text" id="truckYear"
            className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#C0C0C0]" placeholder="2016" />

          <label className="block text-sm text-[#636363] mt-4" htmlFor="truckType">Type</label>
          <select id="truckType" className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#C0C0C0]">
