...
return (
<section  className='fixed inset-0 z-[9999] top-0 left-0 w-full h-full bg-black/40  flex justify-center items-center '>
    <div className="w-full mx-10 max-w-5xl bg-white rounded-2xl p-8">
        <h2 className="text-2xl font-medium mb-6 text-start">Create New Task</h2>
        <form>
            <div className="grid grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <input type="text" id="name"
                        className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#C0C0C0]"
                    ...
                    <label className="block text-sm text-[#636363] mt-4" htmlFor="expiryDate">License expiry
                        date</label>
                ...
                <div>
                    ...
                    <input type="text" id="truckModel"
                        className="mt-3 p-2 w-full border border-[#DFE1E2] rounded-md placeholder-[#C0C0C0]"
                        placeholder="Model/brand/series" />

                    <label className="block text-sm text-[#636363] mt-4" htmlFor="truckYear" type='number'>Year</label>
                ...
                <div>
                    ...
                    <label className="block text-sm text-[#636363] mt-4" htmlFor="containerSize">Size</label>
            ...
            <div className="flex justify-between mt-10">
                 <button onClick={onClose} type="submit" className="py-4 px-8 rounded-xl bg-[#F8F8F8] hover:bg-transparent duration-100">Go back</button>

                <button type="submit" className="py-4 px-8 rounded-xl bg-black text-white hover:bg-transparent hover:text-black duration-100">Save edit</button>
            </div>
        </form>
    </div>
</section>
