        ...
        <div className='w-full'>
            ...
            <div className='flex justify-between items-center'>
                <div className=' w-full flex space-x-2 items-center'>
                    ...
                    {/* Container */}
                    <DropDownButton id="container" openId={openId} setOpenId={setOpenId} label="All Container"
                        icon={containerImg} items={[ { label: "All Container" }, { label: "Loaded containers" }, {
                        label: "Empty containers" }, ]} />

                    {/* Truck */}

                    <DropDownButton id="task" openId={openId} setOpenId={setOpenId} label="All Container"
                        icon={truckImg} items={[ { label: "All Container" }, { label: "Online trucks" }, {
                        label: "Offline trucks" }, ]} />
                    {/* Location */}
                    {/* <button className='px-6 h-[60px] bg-white rounded-2xl flex items-center space-x-3'>
                        <img className='w-7' src={locationImg} alt="" />
                        <p>All Location</p>
                        <i className="fa-solid fa-chevron-down -ml-7 text-gray-500 text-sm pointer-events-none"></i>
                    </button> */}

                    {/* date */}
                    <div id="date" openId={openId} setOpenId={setOpenId} className='relative inline-block z-20'>
                        <button onClick={()=> setOpen(!open)} className='px-6 h-[60px] w-[474px] bg-white rounded-2xl 
                        ...
                        <div className={`flex justify-center items-center absolute left-0 top-9 w-auto bg-white
                            rounded-b-2xl mt-2 overflow-hidden transition-all duration-500`}
                            style={{ maxHeight: open ? "200px" : "0px", }}>
                            <div className="flex p-6">
                                <input type="date" className='py-3 px-5 bg-[#F8F8F8] rounded-2xl' />
                ...
                {/* Submit */}
                <button
                    className="px-6 h-[48px] min-w-max flex-shrink-0 bg-black text-white rounded-2xl flex items-center space-x-2 overflow-hidden">
            ...
            {/* maps */}
            <div className='relative w-full h-[700px] bg-white rounded-2xl mt-5 overflow-hidden z-0'>
                <Maps/>
            </div>
